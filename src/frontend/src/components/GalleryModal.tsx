...
import { Images, Loader2, Play, Trash2, Upload, X, ZoomIn } from "lucide-react";
...
export default function GalleryModal({ open, onClose }: Props) {
  ...
  }, [open, actor, isFetching, fetchItems]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const blob = ExternalBlob.fromBytes(uint8Array).withUploadProgress(
        (pct) => setUploadProgress(Math.round(pct * 100)),
      );
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            onClick={lightbox ? () => setLightbox(null) : handleClose}
          />
              ...
              >
                ...
                >
                  {lightbox.mediaType === "video" ? (
                    <video
                      src={ExternalBlob.fromURL(lightbox.blobId).getDirectURL()}
                      controls
          ...
          >
            <div
              className="w-full max-w-4xl bg-zinc-950 border border-temple-gold/40 rounded-2xl shadow-2xl flex flex-col overflow-hidden pointer-events-auto"
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-temple-gold/20 bg-black shrink-0">
                <div className="flex items-center gap-2">
                  <Images size={18} className="text-temple-gold" />
              ...
              <AnimatePresence>
                {showUpload && (
                  <motion.div
                    ...
                    className="overflow-hidden border-b border-temple-gold/20 shrink-0"
                  >
                    <div className="px-6 py-4 bg-zinc-900 flex flex-col gap-3">
              ...
              <div className="overflow-y-auto flex-1 px-6 py-6">
                {loading ? (
                  <div
                    ...
                    className="flex items-center justify-center h-40 text-gray-500 gap-2"
                  >
                  ...
                  >
                    <Images size={36} className="text-temple-gold/20" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {items.map((item, i) => (
                      <motion.div
                        ...
                        className="group relative bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden cursor-pointer hover:border-temple-gold/40 transition-colors"
